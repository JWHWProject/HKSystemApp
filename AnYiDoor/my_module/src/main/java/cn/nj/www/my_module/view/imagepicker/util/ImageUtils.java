package cn.nj.www.my_module.view.imagepicker.util;
        ...
        ImageLoader.getInstance().loadImage(mImageUrl,
                new ImageLoadingListener() {
                    ...
                    public void onLoadingComplete(String imageUri, View view,
                        ...
                        try {
                            image_file = new File(FileSystemManager.getCacheImgFilePath(context));
                            if (!image_file.exists()) {
                                ...
                                if (Environment.getExternalStorageState().equals(
                                    ...
                                    image_file = new File(
                                            FileSystemManager.getCacheImgFilePath(context),
